...
export class ZaguanClient {
    ...
    static reconstructMessageFromChunks(chunks) {
        if (chunks.length === 0) {
            throw new ZaguanError('Cannot reconstruct message from empty chunks array');
        }
    ...
    async transcribeAudio(request, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/audio/transcriptions`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    /**
    ...
    async translateAudio(request, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/audio/translations`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    /**
    ...
    async generateSpeech(request, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/audio/speech`, httpOptions, this.fetchImpl);
        if (!response.ok) {
            await handleHttpResponse(response);
        }
    ...
    async generateImage(request, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/images/generations`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    /**
    ...
    async editImage(request, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/images/edits`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    /**
    ...
    async createImageVariation(request, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/images/variations`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    // ============================================================================
    // EMBEDDINGS ENDPOINT
    ...
    async createEmbeddings(request, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/embeddings`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    // ============================================================================
    // BATCHES ENDPOINTS
    ...
    async createBatch(request, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/batches`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    /**
    ...
    async retrieveBatch(batchId, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/batches/${batchId}`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    /**
     * Cancel a batch
    ...
    async cancelBatch(batchId, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/batches/${batchId}/cancel`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    /**
     * List batches
    ...
    async createAssistant(request, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/assistants`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    /**
    ...
    async retrieveAssistant(assistantId, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/assistants/${assistantId}`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    /**
     * Update an assistant
    ...
    async createThread(request = {}, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/threads`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    /**
    ...
    async retrieveThread(threadId, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/threads/${threadId}`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    /**
     * Delete a thread
    ...
    async createRun(threadId, request, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/threads/${threadId}/runs`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    /**
     * Retrieve a run
    ...
    async retrieveRun(threadId, runId, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/threads/${threadId}/runs/${runId}`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    /**
     * Cancel a run
    ...
    async cancelRun(threadId, runId, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/threads/${threadId}/runs/${runId}/cancel`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    // ============================================================================
    ...
    async createFineTuningJob(request, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/fine_tuning/jobs`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    /**
    ...
    async retrieveFineTuningJob(jobId, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/fine_tuning/jobs/${jobId}`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    /**
    ...
    async cancelFineTuningJob(jobId, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/fine_tuning/jobs/${jobId}/cancel`, httpOptions, this.fetchImpl);
        return handleHttpResponse(response);
    }
    /**
    ...
    async listFineTuningEvents(jobId, options = {}) {
        ...
        const response = await makeHttpRequest(`${this.baseUrl}/v1/fine_tuning/jobs/${jobId}/events`, httpOptions, this.fetchImpl);
        const result = await handleHttpResponse(response);
        return result.data;
    }
    // ============================================================================
