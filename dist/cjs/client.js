...
class ZaguanClient {
    ...
    async messages(request, options = {}) {
        ...
        const response = await (0, http_js_1.makeHttpRequest)(`${this.baseUrl}/v1/messages`, httpOptions, this.fetchImpl);
        return (0, http_js_1.handleHttpResponse)(response);
    }
    /**
    ...
    async countTokens(request, options = {}) {
        ...
        const response = await (0, http_js_1.makeHttpRequest)(`${this.baseUrl}/v1/messages/count_tokens`, httpOptions, this.fetchImpl);
        return (0, http_js_1.handleHttpResponse)(response);
    }
    /**
    ...
    async createMessagesBatch(requests, options = {}) {
        ...
        const response = await (0, http_js_1.makeHttpRequest)(`${this.baseUrl}/v1/messages/batches`, httpOptions, this.fetchImpl);
        return (0, http_js_1.handleHttpResponse)(response);
    }
    /**
    ...
    async getMessagesBatch(batchId, options = {}) {
        ...
        const response = await (0, http_js_1.makeHttpRequest)(`${this.baseUrl}/v1/messages/batches/${batchId}`, httpOptions, this.fetchImpl);
        return (0, http_js_1.handleHttpResponse)(response);
    }
    /**
    ...
    async cancelMessagesBatch(batchId, options = {}) {
        ...
        const response = await (0, http_js_1.makeHttpRequest)(`${this.baseUrl}/v1/messages/batches/${batchId}/cancel`, httpOptions, this.fetchImpl);
        return (0, http_js_1.handleHttpResponse)(response);
    }
    /**
    ...
    async getMessagesBatchResults(batchId, options = {}) {
        ...
        const response = await (0, http_js_1.makeHttpRequest)(`${this.baseUrl}/v1/messages/batches/${batchId}/results`, httpOptions, this.fetchImpl);
        if (!response.ok) {
            await (0, http_js_1.handleHttpResponse)(response);
        }
        if (!response.body) {
            throw new errors_js_1.APIError(500, 'Response body is null');
        }
